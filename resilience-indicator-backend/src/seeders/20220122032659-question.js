module.exports = {
  up: async (queryInterface) => {
    const questions = [
      ...
      [2, 1, 'Do you have your (or your family) financial, household, and medical information in a secure but easily accessible location?', 'Examples of a secure location would be: fireproof and waterproof box, a bank safe deposit box, or a password-protected flashdrive.'],
      ...
      [2, 1, 'Do you have enough water and means to purify if clean water becomes unavailable?', 'Store at least one gallon of water per person per day. Ideally enough for several days.'],
      [2, 1, 'Do you have a post-disaster safety and recovery plan?', 'You can read more about what this would look like at this link: https://www.aafp.org/dam/AAFP/documents/patient_care/disaster/personal-prep/personal-prep.pdf'],
      ...
      [2, 1, 'Are you or someone in your family considered part of a vulnerable population with special health-care needs?', 'A vulnurable individual is any individual, group, or community whose circumstances create barriers to obtaining or understanding information, or the ability to react as the general population.'],
