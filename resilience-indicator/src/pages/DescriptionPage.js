...
const DescriptionPage = () => {
    ...
    return (
        <>
            <Typography color="primary" variant="h3" id="description-title">{survey.title}</Typography>
            <Box m={2} className={classes.divider}></Box>
            <Grid container spacing={1}>
                <Grid item xs={6}>
                    <Gauge score={60} style={{ width: "100%", height: "200px" }} ></Gauge>
                </Grid>
                <Grid item xs container direction="column" spacing={2} columnSpacing={1}>
                    <Grid item xs={6}>
                        ...
                        <Box m={1} className={classes.progressbox}>
                            <Typography id="milestone-progress-title"> Progress to next milestone:</Typography>
                            <ProgressBar now="50" variant="success"></ProgressBar>
                        </Box>
                    </Grid>
                </Grid>
            </Grid>
